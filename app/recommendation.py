...
class recommendation:
    ...
    def recommendation_brand(self):
        ...
        url_brand = 'https://api.barcodespider.com/v1/search?token=eba3ac19cc270a0e8b42&s=' + \
            str(self.brand)
    ...
    def recommendation_category(self):
        url_catageory = 'https://api.barcodespider.com/v1/search?token=eba3ac19cc270a0e8b42&s=' + \
            str(self.category)
